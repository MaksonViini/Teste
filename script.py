...
i = randint(0, 22)
temas = ['Mobilidade urbana sustentável', 'A evasão escolar em questão no Brasil', 'A preservação da saúde mental no mundo globalizado',
...
'Homeschooling - vantagens e desvantagens da educação à distância para a formação básica'
]
sleep(1)
print('BOA')
sleep(1)

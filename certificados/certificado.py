...
def gera_certificado(nome_certificado, nome_arquivo):
    nome_do_arquivo_certificado = 'certificado_' + \
        nome_arquivo.replace(' ', '_') + '.png'
    ...
    imagem_certificado_desenho.text(
        (400, 300), nome_certificado, font=fonte_certificado, fill=(0, 0, 0))
    imagem_certificado_desenho.text(
        (400, 350), text, font=fonte, fill=(0, 0, 0))
    imagem_certificado.save(nome_do_arquivo_certificado,
...
if __name__ == '__main__':
    ...
    for i in range(1, folha_planilha_inscricoes.nrows):
        ...
        nome_certificado = gera_certificado(
            aluno_nome_certificado, aluno_nome_arquivo)
